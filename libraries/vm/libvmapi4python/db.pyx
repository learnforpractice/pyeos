...
cdef extern from "<eosiolib_native/vm_api.h>": # namespace "eosio::chain":
    cdef cppclass vm_api:
        int (*get_table_item_count)(uint64_t code, uint64_t scope, uint64_t table) except +

        int32_t (*db_store_i64)(uint64_t scope, uint64_t table, uint64_t payer, uint64_t id,  const char* data, uint32_t len)  except +
        int32_t (*db_store_i64_ex)(uint64_t code, uint64_t scope, uint64_t table, uint64_t payer, uint64_t id,  const char* data, uint32_t len)  except +
        
        void (*db_update_i64)(int32_t iterator, uint64_t payer, const char* data, uint32_t len)  except +
        void (*db_remove_i64)(int32_t iterator)  except +
        
        void (*db_update_i64_ex)( uint64_t scope, uint64_t payer, uint64_t table, uint64_t id, const char* buffer, size_t buffer_size )  except +
        void (*db_remove_i64_ex)( uint64_t scope, uint64_t payer, uint64_t table, uint64_t id )  except +
        
        int32_t (*db_get_i64)(int32_t iterator, char* data, uint32_t len)  except +
        int32_t (*db_get_i64_ex)( int itr, uint64_t* primary, char* buffer, size_t buffer_size )  except +
        const char* (*db_get_i64_exex)( int itr, size_t* buffer_size )  except +
        
        int32_t (*db_next_i64)(int32_t iterator, uint64_t* primary)  except +
        int32_t (*db_previous_i64)(int32_t iterator, uint64_t* primary)  except +
        int32_t (*db_find_i64)(uint64_t code, uint64_t scope, uint64_t table, uint64_t id)  except +
        int32_t (*db_lowerbound_i64)(uint64_t code, uint64_t scope, uint64_t table, uint64_t id)  except +
        int32_t (*db_upperbound_i64)(uint64_t code, uint64_t scope, uint64_t table, uint64_t id)  except +
        int32_t (*db_end_i64)(uint64_t code, uint64_t scope, uint64_t table)  except +
        
        int32_t (*db_idx64_store)(uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, const uint64_t* secondary)  except +
        void (*db_idx64_update)(int32_t iterator, uint64_t payer, const uint64_t* secondary)  except +
        void (*db_idx64_remove)(int32_t iterator)  except +
        
        int32_t (*db_idx64_next)(int32_t iterator, uint64_t* primary)  except +
        int32_t (*db_idx64_previous)(int32_t iterator, uint64_t* primary)  except +
        int32_t (*db_idx64_find_primary)(uint64_t code, uint64_t scope, uint64_t table, uint64_t* secondary, uint64_t primary)  except +
        int32_t (*db_idx64_find_secondary)(uint64_t code, uint64_t scope, uint64_t table, const uint64_t* secondary, uint64_t* primary)  except +
        int32_t (*db_idx64_lowerbound)(uint64_t code, uint64_t scope, uint64_t table, uint64_t* secondary, uint64_t* primary)  except +
        int32_t (*db_idx64_upperbound)(uint64_t code, uint64_t scope, uint64_t table, uint64_t* secondary, uint64_t* primary)  except +
        int32_t (*db_idx64_end)(uint64_t code, uint64_t scope, uint64_t table)  except +
'''
