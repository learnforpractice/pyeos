...
std::array<InstructionMetric, 256> EosVM::c_metrics;
void EosVM::initMetrics()
{
	static bool done =
	[]()
	{
...
void EosVM::copyCode(int _extraBytes)
{
...
// mod operation.
// Do not inline it.
u256 EosVM::exp256(u256 _base, u256 _exponent)
{
