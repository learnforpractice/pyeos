...
void EosVM::copyDataToMemory(bytesConstRef _data, u256*_sp)
{
...
void EosVM::throwOutOfGas()
{
	BOOST_THROW_EXCEPTION(OutOfGas());
}

void EosVM::throwBadInstruction()
{
	BOOST_THROW_EXCEPTION(BadInstruction());
}

void EosVM::throwBadJumpDestination()
{
	BOOST_THROW_EXCEPTION(BadJumpDestination());
}

void EosVM::throwDisallowedStateChange()
{
...
void EosVM::throwBadStack(unsigned _removed, unsigned _added)
{
...
void EosVM::throwBufferOverrun(bigint const& _endOfAccess)
{
...
int64_t EosVM::verifyJumpDest(u256 const& _dest, bool _throw)
{
	// check for overflow
...
bool EosVM::caseCallSetup(CallParameters *callParams, bytesRef& o_output)
{
