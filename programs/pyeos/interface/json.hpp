...
using namespace fc;
   ...
   class json
   {
      public:
         ...
         static PyDict& to_stream(PyDict& dict, const variants& v, output_formatting format = stringify_large_ints_and_doubles);
         ...
         static PyObject* to_string( const variant& v, output_formatting format = stringify_large_ints_and_doubles);
         ...
         template <typename T>
         static PyObject* to_string( const T& v, output_formatting format = stringify_large_ints_and_doubles) {
